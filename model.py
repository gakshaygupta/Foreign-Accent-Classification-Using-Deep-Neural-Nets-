...
model.add(Conv2d(64,[2,2],input_shape=[96,128,3],activation="relu",kernel_regularizer=l2(0.01)))
...
model.fit(np.array(X_train),np.array(Y_train),50*2,400,validation_data=[np.array(X_test),np.array(Y_test)],shuffle=True)
